...
export const pastEvents = [
  {
    ...
    title: "DESIGNDRAFT",
    description:
      "‼ Announcement ‼ DESIGNDRAFT – A Premier Workshop on Computer-Aided Design & Drafting (CADD) & 3D Modeling!* 🔧 Get Hands-On with Industry-Leading Design! Tech-O-Nicks, the official tech club of CGEC, is going to organize an exclusive 5-day workshop designed to elevate your skills in Computer-Aided Design & Drafting (CADD) and 3D Modeling. 🖌 Workshop Highlights: 1. AutoCAD 2D: •	Learn 2D Design Techniques for precise machine drafting and architectural planning. 2. Revit: •	Dive into building design processes using this revolutionary tool.3. SolidWorks: •	Unlock the power of advanced 3D modeling for industrial-grade machine design. 🌟 Bonus Features: 	Live Demonstrations: Witness real-time design workflows.	Hands-On Training: Practice in guided sessions tailored for beginners.	Exclusive Tips & Tricks: Speed up your designs with insider shortcuts and workflows.	Networking Opportunities: Connect with mentors and peers to share ideas and expand your network. 🏅 Perks for Participants: Certification of Excellence for attendees with 80% or more participation.📍 Event Details: Venue: AC118, CGEC Dates: Starting 2nd December *Timing: 3:00 PM ",
    image: designdraft,
  ...
  },
  {
    ...
    title: "DEVIGNITE",
    description:
      "📢 ANNOUNCEMENT: DEVIGNITE IS HERE! The Tech-O-Nicks proudly presents *DEVIGNITE* – a dynamic seminar that sparks innovation and empowers your coding skills! Delve into the world of Web Development and unlock the secrets of C programming through our insights, interactive sessions, and hands-on learning. 📅 Date : 26th November - 29th November ⏰ Time: 3:00 PM-5:00 PM 📍 Venue: Central facility lab This event is your chance to improve your skills and learn alongside us. ",
    image: devignite,
