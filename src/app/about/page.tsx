          ...
          <div className=" flex flex-col gap-6 md:flex-row mt-2 sm:mt-8">
            <ul className="flex flex-col gap-4 text-[1.1rem] sm:text-xl">
              ...
              <li>
                ...
                : We encourage students to participate in hackathons, both
                within the college and at national levels, to innovate and
          ...
          <div className="py-4 md:py-10 backdrop-blur-sm bg-white/5 px-3 md:px-6 my-2 shadow-[5px_5px_100px_5px_rgba(76,12,66,0.8)]">
            ...
            <div className="text-2xl my-4 relative z-20 text-center sm:text-start">
              <div>
                ...
                <br />
                <span className="my-3 text-xl text-center">
                  HOD , Electronics & Communication Engineering, CGEC
                </span>
              </div>
            </div>
            <div className="flex flex-col-reverse lg:flex-row-reverse sm:gap-10 sm:px-8">
              <p className="text-[1.1rem] sm:text-xl relative z-20 my-4">
                Welcome to Tech-O-Nicks, the vibrant technology club of Cooch
                Behar Government Engineering College! We are a multidisciplinary
                community that brings together innovators, thinkers, and
                problem-solvers from all departments to explore, learn, and
                create. At Tech-O-Nicks, we believe in the power of technology
                to transform lives. Our club is a platform where students can
                engage with the latest trends, ideas, and advancements in the
                tech world. We organize regular tech talks, workshops, events,
                and alumni interactions that foster collaboration, creativity,
                and skill-building. Our events are designed to be inclusive,
                interactive, and informative, covering a wide range of topics
                from AI and data science to cybersecurity, coding, and more. We
                are not limited by departmental boundaries, and our members come
                from diverse backgrounds, united by a shared passion for
                technology. Join us to: - Expand your knowledge and skills -
                Network with fellow tech enthusiasts - Showcase your projects
                and ideas - Learn from industry experts and alumni At
                Tech-O-Nicks, we are shaping the future of technology, together.
                Come be a part of our community and let us innovate, create, and
                inspire!
              </p>
              <Image
                src={drPDas}
