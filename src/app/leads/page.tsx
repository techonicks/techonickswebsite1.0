...
const page = () => {
  return (
    <div className="flex px-4 md:px-10 py-4 flex-col">
      ...
      <h1 className="text-center mt-10 text-xl md:text-3xl text-green-700">Session : 2024-25 (Current)</h1>
      <div className="flex flex-col md:flex-row justify-center items-center my-5 sm:my-8 md:my-10 gap-8 md:gap-20">
        {incharges
          .filter((lead) => lead.tenure === "2024-25")
          .map((lead, i) => (
            <div
              key={i}
      ...
      <h1 className="text-center mt-10 text-xl md:text-3xl text-green-700">Session : 2023-24</h1>
      <div className="flex flex-col md:flex-row justify-center items-center my-5 sm:my-8 md:my-10 gap-8 md:gap-20">
        {incharges
